...
from openfold_light.errors import MultipleChainsError
import openfold_light.residue_constants as residue_constants
...
def get_atom_coords(
    mmcif_object: MmcifObject, 
    chain_id: str, 
    _zero_center_positions: bool = False # jhl: could mess up contact computation
